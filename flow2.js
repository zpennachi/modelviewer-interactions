    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Define updateAnimationFrame at a higher scope to ensure it's accessible where needed
        ...
        if (scrollAnimateModel) {
            ...
            scrollAnimateModel.addEventListener('load', function() {
                updateAnimationFrame(); // Now accessible
            });

            window.addEventListener('scroll', updateAnimationFrame); // Now accessible
        }
        ...
        if (scrollAnimateModel) {
            ...
            function revertToOriginalAnimation() {
                ...
                updateAnimationFrame(); // Now correctly defined when called
                scrollAnimateModel.pause();
            }
